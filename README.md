# Functional Python [![](https://github.com/joeybodoia/functional-python/workflows/tests/badge.svg)](https://github.com/joeybodoia/functional-python/actions?query=workflow%3Atests)
